// mooncake-store/tests/hot_standby_ut/mock_snapshot_provider.h
#pragma once
...
class MockSnapshotProvider : public SnapshotProvider {
   public:
    ...
    bool LoadLatestSnapshot(
        ...
        override {
        if (should_fail_ || snapshot_id_.empty()) {
            return false;
        }
        snapshot_id = snapshot_id_;
        snapshot_sequence_id = snapshot_seq_id_;
        snapshot = snapshot_data_;
        return true;
    }
